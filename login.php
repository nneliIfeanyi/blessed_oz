...
$canManageUsers = isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] === '1' && isset($_SESSION['role']) && $_SESSION['role'] === 'super_admin';
...
if (isset($_SESSION['loggedIn']) && !($canManageUsers && ($action == 'register' || $action == 'resetPassword'))) {
...
<body>
	...
	<?php
	if ($action !== '') {
		if (($action == 'register' || $action == 'resetPassword') && !$bootstrapMode && !$canManageUsers) {
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="">
							...
							<?php if ($bootstrapMode || $canManageUsers) { ?><a href="login.php?action=register" class="btn btn-success">Register</a><?php } ?>
							<?php if ($bootstrapMode || $canManageUsers) { ?><a href="login.php?action=resetPassword" class="btn btn-warning">Reset Password</a><?php } ?>
